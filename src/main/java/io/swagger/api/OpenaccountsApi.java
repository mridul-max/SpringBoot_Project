...
public interface OpenaccountsApi {
    ...
    @Operation(summary = "this will allow a user to open account", description = "", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Accounts" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Account creation successful", content = @Content(schema = @Schema(implementation = AccountResult.class))),
        
        @ApiResponse(responseCode = "400", description = "Account creation Failed") })
    @RequestMapping(value = "/openaccounts",
