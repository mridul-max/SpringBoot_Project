...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<UserTypeEnum> userTypeEnums) {

        Claims claims = Jwts.claims().setSubject(username);
        claims.put("auth", userTypeEnums.stream().map(s -> new SimpleGrantedAuthority(s.getAuthority())).filter(Objects::nonNull).collect(Collectors.toList()));
